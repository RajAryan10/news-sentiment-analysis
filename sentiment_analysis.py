...
class SentimentAnalyzer:
    ...
    def analyze_sentiment(self, text):
        sentiment = self.sentiment_pipeline(text,truncation=True)
        return sentiment[0]
